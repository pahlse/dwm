...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("pamixer --allow-boost -i 3; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY|ShiftMask,		XK_r,		spawn,		SHCMD("rstudio-bin") },
	...
	{ 0,			XK_F1,		spawn,		SHCMD("zathura /home/shared/docs/eth/stundenplan/stundenplan.pdf") },
	{ 0,			XK_F2,		spawn,		SHCMD("tutorialvids") },
	{ 0,			XK_F3,		spawn,		SHCMD("displayselect") },
	{ 0,			XK_F4,		spawn,		SHCMD("st -e pulsemixer; kill -44 $(pidof dwmblocks)") },
	{ 0,			XK_F5,		xrdb,		{.v = NULL } },
	{ 0,			XK_F6,		spawn,		SHCMD("torwrap") },
	{ 0,			XK_F7,		spawn,		SHCMD("td-toggle") },
	{ 0,			XK_F8,		spawn,		SHCMD("mailsync") },
	{ 0,			XK_F9,		spawn,		SHCMD("dmenumount") },
	{ 0,			XK_F10,		spawn,		SHCMD("dmenuumount") },
	{ 0,			XK_F11,		spawn,		SHCMD("mpv --no-cache --no-osc --no-input-default-bindings --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") },
	{ 0,			XK_F12,		spawn,		SHCMD("st -e setxkbmap ch && remaps") },
